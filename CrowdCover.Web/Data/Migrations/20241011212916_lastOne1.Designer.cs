...
namespace CrowdCover.Web.Data.Migrations
{
    ...
    [Migration("20241011212916_lastOne1")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CrowdCover.Web.Models.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CrowdCover.Web.Models.Sharpsports.Book", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<int?>("MaxHistoryBets")
                        .HasColumnType("int");

                    b.Property<int?>("MaxHistoryMonths")
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime?>("PullBackToDate")
                        .HasColumnType("datetime2");

                    b.Property<bool>("RefreshCadenceActive")
                        .HasColumnType("bit");

                    b.Property<bool>("SdkRequired")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("CrowdCover.Web.Models.Sharpsports.StreamingRoomBook", b =>
                {
                    b.Property<int>("StreamingRoomId")
                        .HasColumnType("int");

                    b.Property<string>("BookId")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("StreamingRoomId", "BookId");

                    b.HasIndex("BookId");

                    b.ToTable("StreamingRoomBooks");
                });
            ...
            modelBuilder.Entity("CrowdCover.Web.Models.StreamingRoomEvent", b =>
                {
                    b.Property<int>("StreamingRoomId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("StreamingRoomId", "EventId");

                    b.HasIndex("EventId");

                    b.ToTable("StreamingRoomEvents");
                });

            modelBuilder.Entity("CrowdCover.Web.Models.UserExtra", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("SharpsportBettorId")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("CrowdCover.Web.Models.Sharpsports.BetSlip", b =>
                {
                    b.HasOne("CrowdCover.Web.Models.Sharpsports.Book", "Book")
                        .WithMany()
            ...
            modelBuilder.Entity("CrowdCover.Web.Models.Sharpsports.Book", b =>
                {
                    b.OwnsOne("CrowdCover.Web.Models.Sharpsports.BetPlaceStatus", "BetPlaceStatus", b1 =>
                        {
                            b1.Property<string>("BookId")
                                .HasColumnType("nvarchar(450)");

                            b1.Property<string>("Android")
                                .IsRequired()
                                .HasMaxLength(50)
                                .HasColumnType("nvarchar(50)");

                            b1.Property<string>("WebBrowser")
                                .IsRequired()
                                .HasMaxLength(50)
                                .HasColumnType("nvarchar(50)");

                            b1.Property<string>("iOS")
                                .IsRequired()
                                .HasMaxLength(50)
                                .HasColumnType("nvarchar(50)");
            ...
            modelBuilder.Entity("CrowdCover.Web.Models.Sharpsports.StreamingRoomBook", b =>
                {
                    b.HasOne("CrowdCover.Web.Models.Sharpsports.Book", "Book")
                        .WithMany("StreamingRoomBooks")
                        .HasForeignKey("BookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CrowdCover.Web.Models.StreamingRoom", "StreamingRoom")
                        .WithMany("StreamingRoomBooks")
                        .HasForeignKey("StreamingRoomId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Book");

                    b.Navigation("StreamingRoom");
                });

            modelBuilder.Entity("CrowdCover.Web.Models.StreamingRoomEvent", b =>
                {
                    b.HasOne("CrowdCover.Web.Models.Sharpsports.Event", "Event")
                        .WithMany("StreamingRoomEvents")
                        .HasForeignKey("EventId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CrowdCover.Web.Models.UserExtra", b =>
                {
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", "User")
                        .WithOne()
                        .HasForeignKey("CrowdCover.Web.Models.UserExtra", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CrowdCover.Web.Models.Sharpsports.Book", b =>
                {
                    b.Navigation("StreamingRoomBooks");
                });

            modelBuilder.Entity("CrowdCover.Web.Models.Sharpsports.Event", b =>
                {
                    b.Navigation("StreamingRoomEvents");
                });
